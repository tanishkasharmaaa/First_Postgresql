  ...
  try {
    ...
    for (const user of usersData) {
      const result = await client.query(
        `INSERT INTO users (name, email, password, phone, city, company, website, avatar_url)
    ...
    const productsData = [
      // Electronics & Gadgets
      {
        title: "iPhone 15 Pro",
        description:
          "Latest Apple flagship with A17 Pro chip and advanced camera system",
        price: 999.99,
        discount_percent: 10,
        stock: 30,
        image_url:
      ...
      },
      {
        ...
        description:
          "Powerful Android flagship with stunning display and AI features",
        price: 1199.99,
        discount_percent: 15,
        stock: 25,
        image_url:
      ...
      },
      {
        ...
        description:
          "Powerful laptop for professionals with M3 chip and stunning display",
        price: 2499.99,
        discount_percent: 5,
        stock: 15,
        image_url:
      ...
      },
      {
        ...
        stock: 45,
        image_url:
          "https://images.unsplash.com/photo-1535869669851-3898991b1df2?w=500&h=500&fit=crop",
        category: "Gaming",
        brand: "Nintendo",
        rating: 4.7,
      },
      ...
      },
      {
        ...
        description:
          "Smartphone with advanced AI and computational photography",
        price: 999.99,
        discount_percent: 12,
        stock: 28,
        image_url:
    ...
    for (const product of productsData) {
      const result = await client.query(
        `INSERT INTO products (title, description, price, discount_percent, stock, image_url, category, brand, rating)
      ...
      for (let j = 0; j < extraCount; j++) {
        const url = `https://images.unsplash.com/photo-${Math.floor(
          1500000000 + Math.random() * 1000000,
    ...
    for (const todo of todosData) {
      await client.query(
        `INSERT INTO todos (title, description, status, user_id, due_date, priority)
         VALUES ($1, $2, $3, $4, $5, $6)`,
        [
          todo.title,
          todo.description,
    ...
    const recipesData = [
      {
        ...
        instructions:
          "Cook pasta, crisp bacon, mix with eggs and pasta water, combine all",
        category: "Pasta",
        cuisine: "Italian",
        prep_time: 5,
        cook_time: 20,
        ...
        rating: 4.8,
        image_url:
          "https://images.unsplash.com/photo-1612874742237-415c69f18d29?w=500&h=500&fit=crop",
      },
      {
        name: "Chicken Tikka Masala",
        description: "Creamy Indian curry with marinated chicken",
        ingredients:
          "chicken breast, yogurt, tomato sauce, cream, spices, onion, garlic",
      ...
      },
      {
        ...
        ingredients:
          "ground beef, taco shells, lettuce, cheese, salsa, tomato, onion",
      ...
      },
      {
        ...
        ingredients:
          "rice noodles, shrimp, eggs, peanuts, lime, fish sauce, vegetables",
        instructions:
          "Stir fry noodles, shrimp and vegetables, finish with sauce and peanuts",
        category: "Stir-fry",
        cuisine: "Thai",
        prep_time: 15,
        cook_time: 20,
        ...
        rating: 4.6,
        image_url:
          "https://images.unsplash.com/photo-1581337134588-3ea9597fbf6d?w=500&h=500&fit=crop",
      },
      {
        name: "Grilled Salmon",
        description: "Fresh salmon fillet with lemon and herbs",
        ingredients:
          "salmon fillet, lemon, rosemary, thyme, olive oil, salt, pepper",
        instructions:
          "Season salmon, grill at high heat until just cooked through",
        category: "Seafood",
      ...
      },
      {
        ...
        ingredients:
          "flour, cocoa powder, sugar, eggs, butter, milk, vanilla, salt",
        instructions:
          "Mix ingredients, bake at 350F for 30-35 minutes, cool, frost",
        category: "Dessert",
        cuisine: "American",
        prep_time: 20,
        cook_time: 35,
      ...
      ...Array.from({ length: 24 }, (_, i) => ({
        ...
        instructions:
          "Step 1: Prepare ingredients. Step 2: Cook. Step 3: Serve.",
        category: [
          "Pasta",
          "Curry",
          "Stir-fry",
    ...
    for (const recipe of recipesData) {
      await client.query(
        `INSERT INTO recipes (name, description, ingredients, instructions, category, cuisine, prep_time, cook_time, servings, difficulty, rating, image_url)
    ...
    const postsData = [
      {
        ...
        content:
          "TypeScript is a powerful tool for JavaScript development. Learn the basics and benefits in this comprehensive guide.",
        user_id: userIds[0],
        likes: 15,
      },
      {
        ...
        content:
          "Learn how to design scalable and maintainable REST APIs. We cover versioning, authentication, and error handling.",
        user_id: userIds[1],
        likes: 22,
      },
      {
        ...
        content:
          "Essential tips for designing efficient database schemas. Normalization, indexing, and relationships explained.",
        user_id: userIds[2],
        likes: 18,
      },
      {
        ...
        content:
          "Understanding React Hooks and how to use them effectively in your applications. useState, useEffect, and custom hooks.",
        user_id: userIds[0],
        likes: 30,
      },
      {
        ...
        content:
          "Containerization with Docker makes deployment easier and more predictable. Get started with containers today.",
        user_id: userIds[1],
        likes: 25,
      },
      ...Array.from({ length: 10 }, (_, i) => ({
    ...
    for (const post of postsData) {
      const result = await client.query(
        `INSERT INTO posts (title, content, user_id, likes)
         VALUES ($1, $2, $3, $4)
         RETURNING id`,
        [post.title, post.content, post.user_id, post.likes],
      );
    ...
    for (const comment of commentsData) {
      await client.query(
        `INSERT INTO comments (post_id, user_id, content, likes)
         VALUES ($1, $2, $3, $4)`,
        [comment.post_id, comment.user_id, comment.content, comment.likes],
      );
    }
    ...
    console.log(
      `   ✓ ${recipesData.length} Recipes (30+ international cuisines)`,
    );
    ...
    console.log(
      "   (Also: jane@example.com, bob@example.com with same password)\n",
    );
